export const company = {
  ...
  social: [
    { label: "Google Places", href: "https://maps.google.com", icon: "places" },
...
export const whyChooseUs = {
  ...
  highlight: {
    value: "B2B",
    label: "Technical-first approach",
  },
  items: [
    {
...
export const applications = applicationsSection.applications.map(({ title, icon }) => ({ title, icon }));
